...
def update_word(dict, key="", value=""):
  ...
  if(value==""):
    print("You need to send a word and a definistion to update.")
    return
  ...
  if(key in dict):
    dict[key] = value
    print(key + " has been updated to: " + dict[key])
    return

def delete_from_dict(dict, key="", value=""):
  if(isinstance(dict, str)):
    print("You need to send a dictionary. You sent: <class 'str>'")
    return
