...
def add_to_dict(my_dict, key, value="none"):
...
def get_from_dict(my_dict, key="none"):
    if type(my_dict) is not dict:
        print(f"You need to send a dictionary. You sent: {type(my_dict)}")
    elif key == "none":
...
def update_word(my_dict, key="none", value="none"):
    if type(my_dict) is not dict:
        print(f"You need to send a dictionary. You sent: {type(my_dict)}")
    elif key == "none" or value == "none":
        print("You need send a word and a definition to update.")
...
def delete_from_dict(my_dict, key="none"):
    if type(my_dict) is not dict:
        print(f"You need to send a dictionary. You sent: {type(my_dict)}")
    elif key == "none":
